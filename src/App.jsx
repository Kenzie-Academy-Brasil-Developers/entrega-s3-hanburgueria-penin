...
function App() {
  ...
  return (
    <>
      ...
      <HomePage cartList={cartList} addCart={addCart} setIsOpen={setIsOpen}/>
      {isOpen ? <CartModal cartList={cartList} addCart={addCart} removeCart={removeCart} setIsOpen={setIsOpen} setCartList={setCartList}/> : null}
    </>
  )
}
